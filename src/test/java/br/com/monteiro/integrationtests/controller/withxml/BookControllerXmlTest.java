...
public class BookControllerXmlTest extends AbstractIntegrationTest {
    ...
    public void testHATEOAS() {
        ...
        assertTrue(content.contains("<links><rel>self</rel><href>http://localhost/api/book/v1/9</href></links>"));
        ...
        assertTrue(content.contains("<links><rel>self</rel><href>http://localhost/api/book/v1/7</href></links>"));
        assertTrue(content.contains("<links><rel>self</rel><href>http://localhost/api/book/v1/14</href></links>"));
        assertTrue(content.contains("<links><rel>self</rel><href>http://localhost/api/book/v1/6</href></links>"));
        assertTrue(content.contains("<links><rel>self</rel><href>http://localhost/api/book/v1/1</href></links>"));

        assertTrue(content.contains("<links><rel>first</rel><href>http://localhost/api/book/v1/?direction=asc&amp;page=0&amp;size=8&amp;sort=author,asc</href></links>"));
        assertTrue(content.contains("<links><rel>self</rel><href>http://localhost/api/book/v1/?page=0&amp;size=8&amp;direction=asc</href></links>"));
        assertTrue(content.contains("<links><rel>next</rel><href>http://localhost/api/book/v1/?direction=asc&amp;page=1&amp;size=8&amp;sort=author,asc</href></links>"));
        assertTrue(content.contains("<links><rel>last</rel><href>http://localhost/api/book/v1/?direction=asc&amp;page=1&amp;size=8&amp;sort=author,asc</href></links>"));

        assertTrue(content.contains("<page><size>8</size><totalElements>15</totalElements><totalPages>2</totalPages><number>0</number></page>"));
