...
public class PersonControllerJsonTest extends AbstractIntegrationTest {
    ...
    public void authorization() throws JsonMappingException, JsonProcessingException {
        ...
        specification = new RequestSpecBuilder()
                .addHeader(TestConfigs.HEADAER_PARAM_AUTHORIZATION, "Bearer " + accessToken)
    ...
    public void testCreate() throws IOException {
        ...
        var content = given()
                .spec(specification)
                .contentType(TestConfigs.CONTENT_TYPE_JSON)
                .header(TestConfigs.HEADAER_PARAM_ORIGIN, TestConfigs.ORIGIN_MONTEIRO)
                .body(person)
                .when()
                .post()
                .then()
    ...
    public void testCreateWithWrongOrigin() throws IOException {
        ...
        var content = given()
                .spec(specification)
                .contentType(TestConfigs.CONTENT_TYPE_JSON)
                .header(TestConfigs.HEADAER_PARAM_ORIGIN, TestConfigs.ORIGIN_SUMARE)
                .body(person)
                .when()
                .post()
                .then()
