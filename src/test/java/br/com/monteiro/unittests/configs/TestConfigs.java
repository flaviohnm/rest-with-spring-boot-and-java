package br.com.monteiro.unittests.configs;

public class TestConfigs {

    public static final int  SERVER_PORT = 8888;

    public static final String HEADAER_PARAM_AUTHORIZATION = "Authorization";
    public static final String HEADAER_PARAM_ORIGIN = "Origin";
