...
import br.com.monteiro.unittests.mocks.MockBook;
...
class BookServicesTest {
    ...
    void testFindById() {
        ...
        assertEquals("Some Author1", result.getAuhtor());
    ...
    void testCreateWithNullBook() {
        ...
        String expecetedMessage = "It is not allowed to persist a null object";
        String actualMessage = exception.getMessage();

        assertTrue(actualMessage.contains(expecetedMessage));
    ...
    void testFindAll() {
        ...
        assertEquals("Some Author1", bookOne.getAuhtor());
        ...
        assertEquals("Some Author4", bookFour.getAuhtor());
        ...
        assertEquals("Some Author7", bookSeven.getAuhtor());
